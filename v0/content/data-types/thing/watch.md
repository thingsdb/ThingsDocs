...
This function returns `nil`, but every call *always* triggers an [init event](../../../watching/on-init), even if it envolves multiple calls of this function on the same thing.
